...
@Component({
  selector: 'app-secondyear-ug',
  templateUrl: './secondyear-ug.component.html',
  styleUrls: ['./secondyear-ug.component.css']
})
export class SecondyearUgComponent {
  ...
  yearFilter: number = 2; // Default year filter
  ...
  calculateCounts(): void{
    const secondYearStudents = this.StudentData.filter(student => student.year === 2  && student.degree === 'UG');
