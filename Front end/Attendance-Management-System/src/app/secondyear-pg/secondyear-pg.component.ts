...
@Component({
  selector: 'app-secondyear-pg',
  templateUrl: './secondyear-pg.component.html',
  styleUrls: ['./secondyear-pg.component.css']
})
export class SecondyearPgComponent {
  ...
  calculateCounts(): void{
    const secondYearStudents = this.StudentData.filter(student => student.year === 2  && student.degree === 'PG');
