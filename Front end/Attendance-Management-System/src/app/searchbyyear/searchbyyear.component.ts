...
@Component({
  ...
  templateUrl: './searchbyyear.component.html',
  styleUrls: ['./searchbyyear.component.css']
})
...
console.log(result);
   this.RestapiService.FindStudentbyYear(result.year,result.startYear,result.endYear,this.adminRole).subscribe(res=>{
