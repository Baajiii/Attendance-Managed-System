...
@Component({
  selector: 'app-thirdyear-ug',
  templateUrl: './thirdyear-ug.component.html',
  styleUrls: ['./thirdyear-ug.component.css']
})
export class ThirdyearUgComponent {
  ...
  yearFilter: number = 3; // Default year filter
  ...
  calculateCounts(): void{
    const secondYearStudents = this.StudentData.filter(student => student.year === 3  && student.degree === 'UG');
